              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="?name=Admin/category/update" method="post"  >
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <textarea name="des" id="des" class="form-control" rows="3" placeholder="description ..."><?php echo'"'.$category['des'].'"'; ?></textarea> 
                        </div>
